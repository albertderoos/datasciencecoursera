...
## 1. Merges the training and the test sets to create one data set.
     ...
     #append the subjects and the activities columns to both test and train datasets
     ...
     ## merge and append labels the train and test data; subject id's are unique between the two sets and total 30 for the 2 sets
     merged <- rbind(traindata2, testdata2) #dim(10299x563)
     activitieslabels2 <- rbind(c(563, "subjects"), c(562, "activities"), features)
     names(merged) <- activitieslabels2$V2
